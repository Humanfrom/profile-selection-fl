...
const pressVariants = [
    ...
    // },
    {
        ...
        minAngle: 33,
        active: true,
        description:"BFH 1319 30 R0.6 H100 mod<br>M0773 V=12 85° mod",
        gap: 4
    },
    {
        name: "Вариант №2",
...
function pressVariantSelect(index){
    ...
    document.querySelector("#press-list > .preview > h1").innerText = pressVariants[index].name || `bending-press-id: ${pressVariants[i].id}`;
...
var bend = {
    ...
    bend(_simEnd = bend.simEnd){
        ...
        if(bend.controller != undefined){
            ...
            const col = strengthTable.columns.indexOf(pressVariants[bend.controller.selectedPress].gap)
